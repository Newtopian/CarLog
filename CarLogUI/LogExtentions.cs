...
namespace CarLog
{
    ...
    public static class LogExtensions
    {
        ...
        /// </summary>
        private static readonly Lazy<ConcurrentDictionary<string, ILogger>> LoggerDictionary =
            new Lazy<ConcurrentDictionary<string, ILogger>>(() => new ConcurrentDictionary<string, ILogger>());
        ...
        {
            return LoggerDictionary.Value.GetOrAdd(objectName, LogManager.GetLogger(objectName));
        }
    }
}
